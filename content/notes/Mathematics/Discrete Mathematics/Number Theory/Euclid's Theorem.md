**Euclid's Theorem** is a fundamental, that asserts that there are infinitely many [[notes/Mathematics/Discrete Mathematics/Number Theory/Prime numbers|prime numbers]].
